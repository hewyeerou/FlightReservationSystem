            ...
            while (response < 1 || response > 2)
            {
                ...
                if(response == 1)
                {
                    try 
                    {
                        ...
                        salesManagementModule = new SalesManagementModule(currentEmployee, flightSessionBeanRemote, flightReservationRecordSessionBeanRemote);
